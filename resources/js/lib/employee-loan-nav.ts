...
export const EMPLOYEE_LOAN_NAV_GROUPS: EmployeeLoanNavGroup[] = [
    ...
    },
    {
        ...
        items: [
            ...
            { title: 'Rebate & Full Payment', path: '/loan-collection/rebate', permission: 'employee-loan.edit', description: 'Rebate SC and collect remaining balance to close the loan' },
...
export const EMPLOYEE_LOAN_LAYOUT_SECTIONS: EmployeeLoanLayoutSection[] = [
    ...
    },
    {
        ...
        items: [
            ...
            { id: 'collection-rebate', label: 'Rebate & Pay', href: '/loan-collection/rebate' },
