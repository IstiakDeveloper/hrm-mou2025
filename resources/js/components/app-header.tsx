        ...
        <>
            <div className="border-sidebar-border/80 border-b">
                <div className="mx-auto flex h-16 items-center px-4 md:max-w-7xl">
                    ...
                    <Link href="/sections" prefetch className="flex items-center space-x-2">
                        <AppLogo />
                    </Link>
                    ...
                    <div className="ml-auto flex items-center space-x-2">
                        <a
                            ...
                            target="_self"
                            className="group mr-2 inline-flex items-center justify-center gap-2 rounded-xl bg-slate-900 p-2 text-xs font-bold text-white shadow-md transition-colors hover:bg-sky-600 sm:px-3 sm:py-1.5 dark:bg-sky-600 dark:hover:bg-sky-500"
