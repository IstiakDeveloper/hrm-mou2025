...
export default function SalaryGradeCreate({ payscales }: { payscales: PayscaleOption[] }) {
    ...
    return (
        <Layout>
            <Head title="Create Salary Grade" />
            <div className="container mx-auto max-w-2xl py-8">
                ...
                <form onSubmit={(e) => { e.preventDefault(); post(route('salary-grades.store')); }}>
                    <Card>
                        <CardHeader><CardTitle>New salary grade</CardTitle></CardHeader>
                        <CardContent className="space-y-4">
                            ...
                            <div>
                                ...
                                <Input value={data.name} onChange={(e) => setData('name', e.target.value)} placeholder="e.g. XII" required />
                                <p className="text-xs text-muted-foreground mt-1">Roman numeral or label shown on salary sheet</p>
