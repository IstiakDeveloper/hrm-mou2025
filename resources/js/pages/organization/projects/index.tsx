...
export default function ProjectsIndex({ projects, filters }: Props) {
    ...
    const handleSearch = () => {
        router.get(route('projects.index'), { search, per_page: perPage }, { preserveState: true });
    };

    const handlePerPageChange = (value: string) => {
        setPerPage(value);
        router.get(route('projects.index'), { search, per_page: value }, { preserveState: true });
    };
            ...
            <PageSurface>
                <div className="mb-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b border-slate-200 pb-5">
                    <div>
                        ...
                        <p className="mt-1 text-sm text-slate-500">Project list used on employee records (optional code / PIN)</p>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-2 w-full md:w-auto">
                        <div className="relative w-full sm:w-64">
                            ...
                            {search && (
                                <button
                                    onClick={() => { setSearch(''); router.get(route('projects.index')); }}
                        ...
                        <div className="flex items-center gap-2 w-full sm:w-auto">
                            ...
                            <Link href={route('projects.create')} className="w-full sm:w-auto">
                                                ...
                                                <TableCell className="text-right pr-6">
                                                    <div className="flex items-center justify-end gap-2 transition-opacity duration-200">
                                                        <Button 
                                                            ...
                                                            title="Edit Project"
                                                            onClick={() => router.get(route('projects.edit', row.id))}
                                                        >
