    ...
    return (
        <Layout>
            ...
            <div className="container mx-auto py-8">
                <Link href={route('projects.index')} className="mb-6 flex w-fit items-center text-gray-500 hover:text-gray-700">
                ...
                <form onSubmit={submit}>
                    <Card className="mx-auto max-w-2xl">
                        <CardHeader className="border-b bg-gray-50">
                            ...
                            <CardDescription>Project name and optional code (unique if set)</CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-4 pt-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <Input id="code" value={data.code} onChange={(e) => setData('code', e.target.value)} placeholder="e.g. P-0001" />
