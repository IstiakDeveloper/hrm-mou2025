...
interface Tier {
    id: number;
    context: 'head_office' | 'branch';
    max_leave_days: number;
    approver_type: 'department_head' | 'executive_director' | 'branch_manager' | 'branch_head' | 'designation';
    designation_id: number | null;
    is_active: boolean;
}

export default function LeaveSettingsEdit({
    tier,
    designations,
}: {
    tier: Tier;
    ...
    const { data, setData, put, processing, errors, transform } = useForm({
        ...
        max_leave_days: String(tier.max_leave_days),
        approver_type: tier.approver_type,
        designation_id: tier.designation_id != null ? String(tier.designation_id) : '',
    ...
    const submit = (e: React.FormEvent) => {
        e.preventDefault();
        put(route('leave.settings.update', tier.id));
    };

    return (
        <Layout>
            <Head title="Edit leave approval tier" />
            ...
            <div className="container mx-auto py-8">
                ...
                <h1 className="mb-8 text-3xl font-bold text-gray-900">Edit tier #{tier.id}</h1>
