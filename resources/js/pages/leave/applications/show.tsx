...
import { ArrowLeft, CheckCircle2, Download, FileDown, FileText, Paperclip, User, UserX, XCircle } from 'lucide-react';
...
export default function Show({ application, canApprove }: ShowProps) {
    ...
    const handleDownloadPdf = () => {
        ...
        window.open(route('leave.applications.pdf', application.id), '_blank');
    };
