...
export default function LoanCollectionSingle({ filters, branches, employees, loans, defaultCollectionDate }: Props) {
    ...
    const submit = (e: React.FormEvent) => {
        ...
        form.post(route('loan-collection.single.store'));
    };

    return (
        <EmployeeLoanLayout
            title="Single collection"
            activeTab="collection-single"
            description="Collect one or more pending installments for a single loan off-payroll."
        >
            <div className="mb-4">
                ...
                <Card className="border-zinc-200/90 shadow-sm">
                    ...
                    <CardContent className="pt-4">
                        ...
                        <div className="mt-4 grid gap-4 sm:grid-cols-2">
                            <PayrollField label="Installment count" error={form.errors.installment_count}>
                                <Input
                                    type="number"
                                    min={1}
