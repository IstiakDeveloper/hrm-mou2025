...
return [
    ...
    'permissions' => [
        ...
        'demotions.view' => ['label' => 'View Demotions', 'category' => 'movement'],
        'demotions.create' => ['label' => 'Create Demotions', 'category' => 'movement'],
        'demotions.edit' => ['label' => 'Edit / Complete Demotions', 'category' => 'movement'],
        'demotions.approve' => ['label' => 'Approve/Reject Demotions', 'category' => 'movement'],
