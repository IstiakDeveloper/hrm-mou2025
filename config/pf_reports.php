...
return [
    ...
    'reports' => [
        ...
        'pf-balance-register' => [
            ...
            'description' => 'Employee-wise PF balance with own and organization contribution totals as of the selected end date.',
            'filters' => ['date_to', 'branch_id', 'department_id', 'employee_id'],
            'template' => 'pf-table',
            'report' => 'pf_balance_register',
        ],
        'pf-balance-register-details' => [
            'title' => 'PF Balance Register (Details)',
            'description' => 'Employee-wise PF balance with opening, contributions, interest, refunds and adjustments as of the selected end date.',
            'filters' => ['date_to', 'branch_id', 'department_id', 'employee_id'],
            'template' => 'pf-table',
