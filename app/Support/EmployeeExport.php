...
final class EmployeeExport
{
    ...
    public static function groupTitles(): array
    {
        return [
            ...
            'collateral_cheque' => 'Collateral Receive Cheques',
            'asset' => 'Assets',
    ...
    private static function extraColumns(): array
    {
        ...
        return [
            ...
            $column('guarantor_father_name', "Guarantor Father's Name", 'guarantor'),
            $column('guarantor_mobile', 'Guarantor Mobile', 'guarantor'),
            $column('guarantor_address', 'Guarantor Address', 'guarantor', 28),
            $column('guarantor_profession', 'Guarantor Profession', 'guarantor'),
            $column('guarantor_organization', 'Guarantor Organization', 'guarantor'),
            $column('guarantor_designation', 'Guarantor Designation', 'guarantor'),
            $column('guarantor_nid', 'Guarantor NID', 'guarantor'),
            $column('guarantor_cheque_bank', 'Cheque Bank', 'guarantor_cheque'),
            $column('guarantor_cheque_number', 'Cheque Number', 'guarantor_cheque'),
            $column('guarantor_cheque_amount', 'Cheque Amount', 'guarantor_cheque'),
            ...
            $column('collateral_cheque_bank', 'Receive Cheque Bank', 'collateral_cheque'),
            $column('collateral_cheque_number', 'Receive Cheque Number', 'collateral_cheque'),
            $column('collateral_cheque_amount', 'Receive Cheque Amount', 'collateral_cheque'),
