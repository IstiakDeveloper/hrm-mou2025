...
class LoanCalculationService
{
     ...
     * }
     */
    public function calculateMigrationSnapshot(LoanPolicy $policy, float $disburseAmount, int $passedMonths): array
    {
        ...
        $monthly = $policy->fixed_installment_amount !== null
            ? SalaryStructureCalculator::roundTaka((float) $policy->fixed_installment_amount)
            : (float) $base['installment_amount_monthly'];
